...
export function ActionButtons({ onDraw, onStop, canDraw, canStop, cardsDrawn }: Props) {
  return (
    <div className="flex gap-3 sm:gap-4 justify-center mt-3 sm:mt-4">
      <button
        onClick={onDraw}
        disabled={!canDraw}
        className={`flex-1 sm:flex-none px-4 sm:px-8 min-h-[44px] py-3 rounded-lg font-bold text-base sm:text-lg transition-all ${
          canDraw
